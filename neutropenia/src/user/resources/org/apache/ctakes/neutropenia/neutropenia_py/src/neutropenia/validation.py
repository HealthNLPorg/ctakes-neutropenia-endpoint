...
from neutropenia_clingen_agents.utils.serialization import (
    remove_non_printable_characters,
)
from neutropenia_clingen_agents.agents.state_model import (
    ClinGenMention,
    Sentence,
)
...
class Validator:
    ...
    def select_non_hallucinatory_attribute(
        ...
        if isinstance(attributes, str):
            ...
            return Validator.select_span(attributes, sample)
        ...
        try:
            ...
            return Validator.select_span(single_attribute, sample)
        except IndexError:
            return None
        except ValueError:
            logger.warning(
            ...
            select_span = partial(Validator.select_span, sample=sample)
